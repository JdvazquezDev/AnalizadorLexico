...
pograma: definicion_programa { printf(" EXITO: programa -> definicion_programa \n"); }
|definicion_libreria { printf(" EXITO: programa -> definicion_libreria \n"); }
;

definicion_programa: PROGRAMA IDENTIFICADOR ';' codigo_programa { printf(" definicion_programa -> PROGRAMA IDENTIFICADOR ';' codigo_porgrama \n"); }
|error ';' {yyerrok;}
;

codigo_programa: cuerpo_subprograma { printf(" codigo_programa -> cuerpo_subprograma \n"); }
|librerias cuerpo_subprograma { printf(" codigo_programa -> librerias cuerpo_subprograma \n"); }
;

librerias: libreria { printf(" librerias -> libreria \n"); }
...
definicion_libreria: LIBRERIA IDENTIFICADOR ';' codigo_libreria  { printf(" defincion_libreria -> LIBRERIA IDENTIFICADOR ';' codigo_libreria \n"); }
;

codigo_libreria:  declaraciones  { printf(" codigo_libreria -> declaraciones \n"); }
...
exportaciones: EXPORTAR nombres ';' { printf(" exportaciones -> EXPORTAR nombres ';' \n"); }
;
...
declaracion_componentes: declaracion_componente { printf(" declaracion_componentes -> declaracion_componente \n"); }
...
llamada_subprograma
 ...
 definicion_parametros: definicion_parametro { printf(" definicion_parametros -> definicion_parametros \n"); }
...
instruccion_bucle
 ...
 ;
clausulas_iteraciones: clausula_iteracion { printf(" clausulas_iteraciones -> clausula_iteracion \n"); }
...
expres: expresion {printf ("expres-> expresion\n");}
|expres ',' expresion {printf("expres -> expres expresion\n"); }
;

expresion: expresion1{ printf(" expresion -> expresion1\n"); }
;

expresion1: expresion1 OR expresion2 { printf(" expresion1 -> expresion1 OR expresion2\n"); }
|expresion2 { printf(" expresion1 -> expresion2\n" ); }
;
expresion2: expresion2 AND expresion3 { printf(" expresion2 -> expresion2 AND expresion3\n"); }
...
;
expresion4: expresion4 '<' expresion5 { printf(" expresion4 -> expresion4 '<' expresion5\n"); }
|expresion4 '>' expresion5 { printf(" expresion4 -> expresion4 '>' expresion5\n"); }
|expresion4 LEQ expresion5 { printf(" expresion4 -> expresion4 '<=' expresion5\n"); }
|expresion4 GEQ expresion5 { printf(" expresion4 -> expresion4 '>=' expresion5\n"); }
|expresion4 '=' expresion5 { printf(" expresion4 -> expresion4 '=' expresion5\n"); }
|expresion4 NEQ expresion5 { printf(" expresion4 -> expresion4 '~=' expresion5\n"); }
|expresion5 { printf(" expresion4 -> expresion5\n"); }
;

expresion5: expresion5 DESPI expresion6 { printf(" expresion5 -> expresion5 '<-' expresion6\n"); }
|expresion5 DESPD expresion6 { printf(" expresion5 -> expresion4 '->' expresion5\n"); }
|expresion6 { printf(" expresion5 -> expresion5 -> expresion6\n"); }
;

expresion6: expresion6 '+' expresion7 { printf("expresion6 -> expresion6 '+' expresion7\n"); }
|expresion6 '-' expresion7 { printf(" expresion6 -> expresion6 '-' expresion7\n"); }
|expresion7 { printf("expresion6 -> expresion6 -> expresion7\n"); }
;

expresion7: expresion7 '*' expresion_potencia { printf("expresion7 -> expresion7 '*' expresion_potencia\n"); }
...
expresion_potencia: expresion_posfija '^' expresion_potencia { printf("expresion_potencia ->  expresion_potencia '^' expresion_posfija\n"); }
...
operador_posfijo: INC { printf("  operador_posfijo -> operador_posfijo '++' \n"); }
|DEC { printf(" operador_posfijo -> operador_posfijo '++' \n"); }
;
...
literal: VERDADERO { printf(" literal -> VERDADERO \n"); }
...
enumeraciones:'[' expresion_condicional clausulas_iteraciones ']' { printf(" enumeraciones -> '[' expresion_condicional clausulas_iteraciones ']' \n"); }
...
claves_valor: clave_valor { printf(" claves_valor -> clave_valor \n"); }
|claves_valor ',' clave_valor { printf(" claves_valor -> claves_valor clave_valor \n"); }
;

campos_valor: campo_valor { printf(" campos_valor-> campo_valor \n"); }
